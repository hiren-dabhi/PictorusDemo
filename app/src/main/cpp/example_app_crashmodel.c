...
JNIEXPORT jobject JNICALL Java_in_matter_pictorusdemo1_SimulationModelAppInterface_appInterfaceUpdate(
    ...
    struct AppDataInput cInput = {
            .Curr = (*env)->GetDoubleField(env, inputData, (*env)->GetFieldID(env, inputClass, "Curr", "D")),
            .Speed = (*env)->GetDoubleField(env, inputData, (*env)->GetFieldID(env, inputClass, "Speed", "D")),
            .Ay = (*env)->GetDoubleField(env, inputData, (*env)->GetFieldID(env, inputClass, "Ay", "D")),
            .EntropyDiff = (*env)->GetDoubleField(env, inputData, (*env)->GetFieldID(env, inputClass, "EntropyDiff", "D"))
    };
